<template>
  <div class="page-just-now-performance">
    <div class="page-header-wrap">
        ...
        <div class="summarizing-wrap" v-show="!dateChangeLoading">
          <div class="all-data-wrap">
            <div class="main-data-wrap">
                <div class="cjl">
                    <span>提成总计（元）</span>
                    <span><i>{{headerDataDetail.dealNum}}</i></span>
                </div>
                <div class="zbl">
                    <span>金融</span>
                    <span>{{headerDataDetail.receptionNum}}<i>元</i></span>
                </div>
                </div>
                ...
                <div class="line-one flex-r flex-b">
                    ...
                    <div class="ecddl">
                    <span>汽车用品</span>
                    <span>{{headerDataDetail.twiceToNum}}<i>元</i></span>
                    </div>
                </div>
                <div class="line-two flex-r flex-b">
                    <div class="ldl">
                    <span>二手车</span>
                    <span>{{headerDataDetail.recordNum}}<i>元</i></span>
                    </div>
                    <div class="sjl">
                    <span>保险</span>
                    <span>{{headerDataDetail.testDriveNum}}<i>元</i></span>
                    </div>
                </div>
                </div>
            </div>
      ...
      <div class="header-data-is-loading" v-show="(headerIsLoading || dateChangeLoading)" :style="(!headerIsLoading && dateChangeLoading) ? { 'height': '4rem' } : {}">
